...
class Lane:
    ...
    def display_curvature_offset(self, frame=None, plot=False):
        ...
        cv2.putText(
            image_copy,
            "Curve Radius: " + str((self.left_curvem + self.right_curvem) / 2)[:7] + " m",
    ...
    def get_lane_line_indices_sliding_windows(self, plot=False):
        ...
        for window in range(no_of_windows):
            ...
            cv2.rectangle(
                frame_sliding_window, (win_xleft_low, win_y_low), (win_xleft_high, win_y_high), (255, 255, 255), 2
            )
            cv2.rectangle(
                frame_sliding_window, (win_xright_low, win_y_low), (win_xright_high, win_y_high), (255, 255, 255), 2
            )
